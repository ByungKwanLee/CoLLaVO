...
class InternLM2MLP(nn.Module):
    ...
    def forward(self, x, seg_mask, im_mask):
        down_proj = self.w2(
            self.act_fn(self.w1(x, seg_mask, im_mask)) * self.w3(x, seg_mask, im_mask), seg_mask=None, im_mask=im_mask)
...
class InternLM2Attention(nn.Module):
    ...
    def forward(
        ...
        **kwargs,
        ...
        qkv_states = self.wqkv(hidden_states, seg_mask, im_mask)
        ...
        attn_output = self.wo(attn_output, seg_mask, im_mask)
...
class InternLM2DecoderLayer(nn.Module):
    ...
    def forward(
        ...
        **kwargs,
        ...
        hidden_states = self.feed_forward(hidden_states, seg_mask, im_mask)
        hidden_states = residual + hidden_states
...
class InternLM2Model(InternLM2PreTrainedModel):
    ...
    def forward(self,
        ...
        seg_mask = kwargs.get('seg_mask', None)
